...
urlpatterns = [
    ...
    url(r'^api/users/most_helpful$', MostHelpfulThisWeek.as_view()),
    url(r'^api/users/(?P<user_id>[0-9]+)$', GetUserView.as_view()),
    url(r'^api/users/(?P<user_id>[0-9]+)/edit$', UpdateUserView.as_view()),
    ...
    url(r'^api/notifications/(?P<user_id>[0-9]+)$', GetAllNotifications.as_view()),
